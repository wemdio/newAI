...
13. crypto — Криптовалюта / P2P (покупка и продажа USDT, BTC, ETH, USDC и других криптовалют, P2P-обмен, обмен крипты на наличные или фиат, криптообменники, поиск курса). Сюда же "куплю usdt", "ищу обмен usdt", "продам крипту за наличные"
...
- КРИПТА ≠ БУХГАЛТЕРИЯ: покупка/продажа USDT, BTC, любой криптовалюты, P2P-обмен, "куплю usdt", "обмен крипты на наличные" = ВСЕГДА category "crypto", НИКОГДА не "finance". В finance попадают только бухгалтерия, налоги, отчётность и аудит.
